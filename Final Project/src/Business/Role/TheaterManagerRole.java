...
import Interface.Theater.BuyCopyrightJPanel;
import Interface.Theater.ManagerWorkAreaJPanel;
...
public class TheaterManagerRole extends Role{
     public JPanel createWorkArea(JPanel userProcessContainer, UserAccount account, Organization organization, EcoSystem business,Enterprise enterprise) {
        return new ManagerWorkAreaJPanel(userProcessContainer,business,account);
    }
}
