...
import Interface.MovieManufacture.DirectorWorkAreaJPanel;
...
public class DirectorRole extends Role{
    public JPanel createWorkArea(JPanel userProcessContainer, UserAccount account, Organization organization, EcoSystem business,Enterprise enterprise) {
        return new DirectorWorkAreaJPanel (userProcessContainer,business,account,enterprise,organization);
    }
}
