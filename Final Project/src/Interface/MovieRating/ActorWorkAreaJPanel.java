...
public class ActorWorkAreaJPanel extends javax.swing.JPanel {
    ...
    public ActorWorkAreaJPanel(JPanel userProcessContainer, UserAccount account, Enterprise enterprise, EcoSystem business) {
       initComponents();
        ...
        for(Network network1:business.getNetworkslist()){
            for(Enterprise enterprise1:network1.getEnterpriseDirectory().getEnterpriseslist()){
                ...
                for(Organization organization1:enterprise1.getOrganizationDirectory().getOrganizationList()){
                    if(organization1 instanceof ActorOrganization){
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Rating Actor Work Area");
